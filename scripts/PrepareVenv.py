...
'''
'''
PrepareVenv.py is a script that install venv in the path sostrades-dev-tools/.venv only if you have a python version 3.12 or higher.
...
if sys.version_info.major < required_python_major_version or (
    ...
    raise Exception(
        f"Python version : {python_version} but python v{required_python_major_version}.{required_python_minor_version}+ is required"
    )
